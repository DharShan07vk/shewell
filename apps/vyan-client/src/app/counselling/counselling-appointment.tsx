  ...
  return (
    <>
      <div className="w-full ">
        <div className="flex   justify-between md:flex-col md:gap-10 md:self-center xl:flex-row xl:justify-between ">
          {/* price */}
          <div className="self-center  ">
            {/* INR {timeDuration?.timeDurations.! / 100} */}
            INR {priceInCents ? priceInCents / 100 : "---"}
          </div>
          {/* both-Buttons */}
            ...
            {timeSlot ? (
              <div onClick={() => handleOpenDialogOnlineAppointment()}>
                ...
                <Button
                  ...
                  // disabled ={session.status === "unauthenticated" || timeSlot === null}
                >
                  <svg
                    className="mr-1"
                    width="19"
              ...
              <HoverCard>
                ...
                <HoverCardContent className="w-full bg-white xs:max-w-[300px] sm:max-w-[375px] p-0">
                  <div className="  p-5">
