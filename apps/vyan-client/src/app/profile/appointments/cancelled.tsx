    ...
    <>
      {isLoading ? (
       <AppointmentSkeleton/>
        ...
        data?.cancelledAppointments.length! > 0 ?
          <div className={`flex  flex-col gap-[14px]  ${data?.cancelledAppointments.length! > 2 ? "h-[400px] overflow-y-scroll" : ""}`}>
                ...
                <div className="flex flex-col gap-[10px] md:flex-row md:items-center md:justify-between ">
                  ...
                  <div className="flex self-end  lg:gap-[26px]">
                    ...
                    <div className="flex gap-[26px]">
                      {/* <Button className="rounded-[3px] border border-[#181818] bg-white px-4 py-2 font-inter text-[14px] font-medium leading-[24px] text-active hover:bg-white">
                      Notify me
                    </Button> */}
                      <Button
                        onClick={() => {
      ...
      </div>  : "There are no cancelled appointments"
      )}
