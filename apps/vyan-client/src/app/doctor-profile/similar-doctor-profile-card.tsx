    ...
    <>
        ...
        <div className="flex gap-4 rounded-md border border-border-300  p-3 md:p-4 lg:gap-6 lg:p-6">
          ...
          <div className="flex flex-col items-center justify-center gap-3 self-center  ">
           <div className="bg-[url('/images/doctor-bg.png')] flex items-center justify-center self-center aspect-square w-[135px] bg-no-repeat bg-center">
           <div className="relative aspect-square w-[116px]">
            ...
            {doctorProfile.professionalUserAppointmentPrices![0]?.priceInCentsForSingle ?  <div> INR {doctorProfile.professionalUserAppointmentPrices![0]?.priceInCentsForSingle/100}</div> : 
            <div>INR{doctorProfile.professionalUserAppointmentPrices![0]?.priceInCentsForCouple!/100}</div>}
            </div> : <div className="font-inter text-[16px] font-semibold text-secondary sm:text-lg"> INR --</div>
          }
          ...
          <div className="flex flex-col gap-1 self-center  ">
            ...
            <div className="flex flex-wrap gap-1 font-inter text-xs font-normal text-inactive md:text-sm items-center">
              ...
              {specialization.map((item, index) => {
                return (
                  <>
                    <div className="text-xs py-1 px-[6px] rounded-[6px] bg-[#F6F6F6] text-inactive" key={index}>{item.specialization}{index < specialization.length - 1 ? "/" : ""}</div>
                  </>
                );
              })}
            </div>
