        ...
        <DropdownMenu>
          ...
          {session.status === "authenticated" ? (
            <DropdownMenuContent className="w-56 bg-white">
              <DropdownMenuLabel className="font-inter text-[18px] font-bold leading-[28px] text-active">
                Profile
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuGroup>
                {/* <Link href="/edit-profile/personal-info">
                  <DropdownMenuItem className=" flex cursor-pointer items-end justify-between px-0">
                    <div className="flex items-end gap-2  px-2 py-[1.5]">
                      {" "}
                      <TbUserEdit className=" h-6 w-5  " />
                      <div className=" pb-0 font-inter text-base font-medium leading-[24px]">
                        Edit-Profile
                      </div>
                    </div>
                    <div className="">
                ...
                <Link href={env.NEXT_PUBLIC_USER} target="_blank" >
                  <DropdownMenuItem className=" flex cursor-pointer items-end justify-between px-0">
                    <div className="flex items-end gap-2  px-2 py-[1.5]">
                      {" "}
                      <PiUserSwitchBold  className=" h-6 w-5  " />
                      <div className=" pb-0 font-inter text-base font-medium leading-[24px]">
                        Switch Account
                      </div>
                    </div>
            ...
            <DropdownMenuShortcut>⇧⌘Q</DropdownMenuShortcut> */}
                <Button
                  ...
                  className="flex w-full items-baseline gap-[12px] rounded-[6px] border border-black bg-white text-black hover:bg-white"
                >
                  <span>
                    <RiLogoutCircleRLine />
                  </span>
            ...
            <DropdownMenuContent className="w-56 bg-white">
              ...
              <DropdownMenuShortcut>⇧⌘Q</DropdownMenuShortcut> */}
                ...
                <Link className="w-full" href="/auth/login">
                  <Button className="flex w-full items-baseline gap-[12px] rounded-[6px] border border-black bg-white text-black hover:bg-white">
                    <span>
                      <RiLogoutCircleRLine />
                    </span>
                    Login
