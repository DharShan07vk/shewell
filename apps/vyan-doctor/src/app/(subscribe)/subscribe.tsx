...
export default function Subscribe() {
  ...
  const submit = (data: z.infer<typeof formSchema>) => {
    ...
    SubscribeAction(data as { email: string })
      .then((resp) => {
        reset(),
        setValue("email", "")
        toast({
    ...
    <>
      <div className="w-full">
        <div className="container mx-auto max-w-full">
          <div className="flex flex-col items-center gap-5    py-8 md:flex-row md:justify-between  md:gap-10 md:py-[55px] xl:gap-[174px] xl:py-[65px] 2xl:gap-[375px] 2xl:py-[70px]">
            {/* Left-div-starts */}
            <div className=" flex flex-col gap-3 md:gap-4 ">
              ...
              {/* <form onSubmit={handleSubmit(submit, error)} noValidate={true}>
                <div className="relative mb-2 mt-6 md:mb-[14px] md:mt-[30px] xl:mb-7 xl:mt-8">
                  <Controller
                    control={control}
                    name="email"
                    render={({ field }) => {
                      return (
                        <>
                          <input
                            className="absolute w-full rounded-full bg-[#00898F] py-5 pl-[52px]  pr-2 font-inter text-base font-normal text-white  shadow-[6px_5px_17px_0px_rgba(53,83,95,0.25)]	 outline-none placeholder:text-white"
                            type="email"
             ...
             <form onSubmit={handleSubmit(submit,error)} noValidate={true}>
             <div className="p-3 w-full flex gap-1 rounded-full bg-[#00898F] items-center">
             ...
             {errors.email && <p className="text-red-500">{errors.email.message}</p>}
              <div className="font-inter text-xs font-normal md:text-sm 2xl:text-base 	">
                Please read our{" "}
            ...
            <Image
                ...
                placeholder='blur'
                blurDataURL="fallback-subscribe.png"
              />
            </div>
