  ...
  return (
    <>
      {blogs.length > 0 ? (
          ...
          <section className="w-full lg:mt-[65px]">
            <div className="container mx-auto">
              <div className="flex flex-col gap-[36px] xl:flex-row xl:gap-[50px]">
                {/* Left Panel */}
                <div className="mb-[20px] w-full md:mb-[28px] lg:mb-[32px] xl:w-2/3 2xl:mb-[50px]">
                      ...
                      <div className="mb-6 flex w-full justify-between">
                        <div className="w-fit font-inter text-lg font-medium leading-7 text-black-400">
                          ...
                          <span className="postdate">
                            {" "}
                            {blog && format(blog.createdAt, "dd MMMM yyyy")}
                          </span>
                        </div>
        ...
        <div className="flex items-center justify-center py-10">There are no blogs yet...</div>
      )}
    </>
  );
};
