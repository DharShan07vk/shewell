...
const DoctorProfile = ({ doctor, cardImage }: IDocProfileProps) => {
  console.log("cardImage", cardImage);
  return (
    <>
      <div className="flex flex-col gap-[18px] md:gap-6">
        <div className="flex gap-4 lg:gap-6 2xl:gap-8">
      <div className="self-center">    {cardImage}</div>

          <div className="flex flex-col gap-1">
            <h3 className="font-inter font-medium 	text-base md:text-[30px] md:leading-[30px] xl:text-2xl 2xl:text-[28px] 2xl:leading-[38px]">
              {doctor.firstName}
            </h3>
            <div className="font-inter font-medium text-sm md:text-lg 2xl:text-[20px] 2xl:leading-[30px]">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="font-inter font-medium text-sm 2xl:text-base">
                {" "}
                {doctor.ratings} |
              </div>
              <div className="font-inter font-normal text-sm 2xl:text-base">
                {" "}
                {doctor.consultation} Counsultation
              </div>
            </div>

            <Button className="mt-4 2xl:mt-5 w-[159px]">
              <svg
                className="mr-[2px]"
                width="24"
                height="24"
        ...
        <div className="text-xs font-inter font-medium text-inactive	">
