        ...
        <div className="w-full bg-blue-100">
          <div className="container mx-auto">
            <div className="top-bar">
              <div className="flex justify-between py-[7px] md:py-2">
                <div className="flex items-center gap-2">
                  ...
                  <Link className="no-underline" href="mailto:vyanji@gmail.com">
                    vyanji@gmail.com
                  </Link>
                </div>

                <div className="flex gap-3 md:gap-[18px] xl:gap-6 2xl:gap-6 ">
                  <div className="group">
                    <Link className="group-hover:hidden" href="#">
                      <svg
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
                    ...
                    <Link className="hidden group-hover:block" href="#">
                      <svg
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
                  ...
                  <div className="group">
                    <Link className="group-hover:hidden" href="#">
                      ...
                      >
                        <rect
                          ...
                          fill-opacity="0.08"
                        />
                        <g clip-path="url(#clip0_1198_27538)">
                          <path
                            d="M21.9963 22V21.9995H21.9998V16.865C21.9998 14.3531 21.459 12.4182 18.5225 12.4182C17.1108 12.4182 16.1635 13.1929 15.7767 13.9273H15.7359V12.6527H12.9517V21.9995H15.8508V17.3713C15.8508 16.1527 16.0818 14.9744 17.5909 14.9744C19.0778 14.9744 19.1 16.365 19.1 17.4495V22H21.9963Z"
                            fill="#0E76A8"
                          />
                          <path
                            d="M8.23096 12.6532H11.1336V21.9999H8.23096V12.6532Z"
                            fill="#0E76A8"
                          />
                          <path
                            d="M9.68117 8C8.75308 8 8 8.75308 8 9.68117C8 10.6092 8.75308 11.3781 9.68117 11.3781C10.6092 11.3781 11.3623 10.6092 11.3623 9.68117C11.3617 8.75308 10.6087 8 9.68117 8V8Z"
                            fill="#0E76A8"
                          />
                        </g>
                        <defs>
                          <clipPath id="clip0_1198_27538">
                            <rect
                              width="14"
                              height="14"
                              fill="white"
                    ...
                    <Link className="hidden group-hover:block" href="#">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <rect width="30" height="30" rx="3" fill="#0E76A8" />
                        <g clip-path="url(#clip0_1198_27540)">
                          <path
                            d="M21.9963 22V21.9995H21.9998V16.865C21.9998 14.3531 21.459 12.4182 18.5225 12.4182C17.1108 12.4182 16.1635 13.1929 15.7767 13.9273H15.7359V12.6527H12.9517V21.9995H15.8508V17.3713C15.8508 16.1527 16.0818 14.9744 17.5909 14.9744C19.0778 14.9744 19.1 16.365 19.1 17.4495V22H21.9963Z"
                            fill="white"
                          />
          ...
          <div className="container mx-auto">
            <div className="middle-bar ">
              <div className=" flex  items-center justify-between py-2.5 md:py-4">
                {/* part-1-start */}
                <div className="relative aspect-[3.68/1] h-[44px] ">
                  <Image
                    src="/images/logo.png"
                    fill
                    alt="logo"
                ...
                <div className="flex items-center gap-[25px] ">
                  <div className="sm:hidden relative lg:block">
                    <input
                      className="hidden rounded-lg border-2 border-black p-2 pl-[38px] font-inter text-sm outline-none hover:cursor-pointer hover:border-yellow-500 md:w-[494px] lg:block xl:w-[893px] 2xl:w-[1005px] "
                      type="search"
                      placeholder="Search"
                    />
          ...
          <div className="container mx-auto">
            <div className="flex items-center justify-between ">
              <Sheet>
                ...
                <SheetContent side="left" className="w-full  overflow-scroll ">
                  <SheetHeader className="mt-3  text-left">
                    {/* <SheetTitle>Are you absolutely sure?</SheetTitle> */}
                    <Link href="#">
                      {" "}
                      <SheetDescription className=" py-2 pl-4 font-inter	text-base font-medium text-active">
                        Home
                      </SheetDescription>
                    </Link>
                    <Link href="#">
                      <SheetDescription>
                        <Accordion type="single" collapsible>
                          <AccordionItem className="border-none" value="item-1">
                            ...
                            <AccordionContent className=" font-inter text-sm font-medium text-inactive">
                              Nutrition
                            </AccordionContent>
                            <AccordionContent className="font-inter text-sm font-medium text-inactive">
                              Personal Care
                            ...
                            <AccordionContent className=" font-inter text-sm font-medium text-inactive">
                              <Accordion type="single" collapsible>
                                <AccordionItem
                                  ...
                                  value="item-1"
                                >
                                  <AccordionTrigger className="pl-0 font-inter text-sm font-medium text-active">
                                    Fertility
                                  </AccordionTrigger>
                                  <AccordionContent className="pl-11 font-inter text-sm font-medium text-inactive">
                                    Nutrition
                                  </AccordionContent>
                                  <AccordionContent className="pl-11 font-inter text-sm font-medium text-inactive">
                                    Personal Care
                    ...
                    <Link href="#">
                      ...
                      <SheetDescription className="mt-2.5">
                        <div className="flex justify-between">
                          <div className="px-[40.5px] font-inter text-sm font-normal text-active">
                    ...
                    <Link href="#">
                      ...
                      <SheetDescription className="pb-2.5  pt-10">
                        <div className="relative aspect-[1/1] h-[359px] ">
                          <Image
              ...
              <div className="relative">
                <input
                  type="email"
                  placeholder="Search"
                  className="w-[282px] rounded-md border bg-black p-2 pl-[38px]"
                />

                <svg
                  className="absolute top-3 border p-2"
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="21"
                  viewBox="0 0 20 21"
